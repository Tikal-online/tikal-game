...
import { ERROR_RESPONSES, HttpResponseData, NOT_FOUND } from '../../tests/http-responses';
...
describe('AccountService', () => {
  ...
  test('getAccount returns NoFound when GET /Api/Accounts/me returns 404', async () => {
  ...
  test('getAccount returns Account when GET /Api/Accounts/me returns 200', async () => {
    const promise = firstValueFrom(service.getAccount());
